...
from dynamic_symmetry_gait import integrate_dynamic_symmetry
from centroidal_wbc import run_centroidal_wbc
...
def run_episode_with_online(
    ...
    from batch_test import GAIT_FREQUENCY, SWING_AMP, BODY_HEIGHT
...
def dynsym_with_sim_guidance(
    ...
    """
    from dynamic_symmetry_gait import DynamicSymmetryGaitPlan
